...
class RulesKeysTest {
    ...
    private Map<String, RuleType> bugs() {
        ...
        bugChecks.put("SameConditionsInIfCheck", RuleType.BUGS);
    ...
    private Map<String, RuleType> metrics() {
        ...
        metrics.put("CognitiveComplexityCheck", RuleType.METRICS);
    ...
    private Map<String, RuleType> vulnerabilities() {
        ...
        vulnerabilities.put("EmptyCatchCheck", RuleType.VULNERABILITIES);
