...
public final class ChecksMetadataUtil {
    ...
    private ChecksMetadataUtil() {
    }

    public static Scope getCheckScope(String checkKey) {
        RuleMetadata metadata = readRuleMetadata(checkKey);
